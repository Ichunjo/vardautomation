...
class MediaInfo:
    ...
    @classmethod
    def parse(cls, filename: Any, library_file: Optional[str] = ..., cover_data: bool = ..., encoding_errors: str = ..., parse_speed: float = ..., full: bool = ..., legacy_stream_display: bool = ..., mediainfo_options: Optional[Dict[str, str]] = ..., output: Optional[str] = ...) -> Union[str, MediaInfo]: ...
    def to_data(self) -> Dict[str, Any]: ...
